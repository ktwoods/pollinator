			...
			<div class="tab-content" id="pills-tabContent">
				<div id="herb" class="tab-pane fade show active" role="tabpanel" aria-labelledby="pills-herb">
					...
					<table>
						...
						<tbody id="herb-list">
							<?php display_tr("select common_name, latin_name, have, want, tags from Plant where tags not like '%shrub%' and tags not like '%tree%' and tags not like '%vine%' order by have desc, latin_name asc"); ?>
						</tbody>
					</table>
					<p>&nbsp;</p>
				</div>
				<div id="woody" class="tab-pane fade" role="tabpanel" aria-labelledby="pills-woody">
					...
					<table>
						...
						<tbody id="wood-list">
							<?php display_tr("select common_name, latin_name, have, want, tags from Plant where tags like '%shrub%' or tags like '%tree%' or tags like '%vine%' order by have desc, latin_name asc"); ?>
						</tbody>
					</table>
					<p>&nbsp;</p>
				</div>
